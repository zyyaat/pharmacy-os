...
func (r *MedicationRepository) ListByPharmacy(ctx context.Context, pharmacyID string) ([]models.Medication, error) {
	_ = pharmacyID
	// Placeholder
...
// TODO: Implement
func (r *MedicationRepository) GetByID(ctx context.Context, id string) (*models.Medication, error) {
	// Placeholder
	return &models.Medication{ID: id}, nil
}
...
func (r *MedicationRepository) GetLowStock(ctx context.Context, pharmacyID string) ([]models.Medication, error) {
	_ = pharmacyID
	// Placeholder
	return []models.Medication{}, nil
}
